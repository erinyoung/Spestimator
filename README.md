...
Needs to
1. install blast database if none present
2. install taxdb database if none present
3. query contigs against 16S database with relevant headers
4. output predicted organisms

```
blastn -query UT-M03999-24022-UPHL-BioNGS_Granduer_V3_2_20230718-cdaf6bd8-41eb-4ad2-ab11-58db8506ed8c/grandeur/contigs/1960992-UT-M03999-240223_contigs.fa -out test.txt -db ~/blast_16S/16S_ribosomal_RNA -outfmt "6 sacc ssciname staxid sblastname"
```
